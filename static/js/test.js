...
function user_modify() {
    ...
    let new_password = $.md5($("#password").val());
    let new_username = $("#username").val();
    let params = {'new_email': new_email, 'new_password': new_password, 'new_username': new_username};
    $.ajax({
        type: 'POST',
        ...
        contentType: 'application/json',
        complete: function (a) {
            let re = 'data:' + JSON.stringify(params) + '\nstatus:' + a.status;
            $("#result").val($("#result").val() + re + '\n');
        }
    })
}
function user_query() {
    $.ajax({
        ...
        crossDomain: true,
        complete: function (a) {
            $("#result").val($("#result").val() + 'status:' + a.status + '\n');
            if(a.status === 200){
...
function admin_search() {
    ...
    let id = $("#user_id").val();
    let params = {'email': email, 'username': username, 'id': id};
    $.ajax({
        type: 'POST',
        ...
        contentType: 'application/json',
        complete: function (a) {
            $("#result").val($("#result").val() + 'data:' + JSON.stringify(params)
                + '\n' + 'status:' + a.status + '\n');
            if (a.status === 200){
                const data = a.responseText;
                $("#result").val($("#result").val() + data + '\n');
...
function book_borrow() {
    ...
    $.ajax({
        ...
        contentType: 'application/json',
        complete: function (a) {
            $("#result").val($("#result").val() + JSON.stringify({'id': id})
                + '\n' + 'status:' + a.status + '\n');
        }
    })
}
...
function book_add() {
    ...
    let params = {'id':id, 'name':name, 'number': number, 'max_time': max_time, 'author': author};
    $.ajax({
        type: 'POST',
        url: urls.book_add,
        data: JSON.stringify(params),
        ...
        crossDomain: true,
        complete: function (a) {
            $("#result").val($("#result").val() + JSON.stringify(params)
                + '\n' + 'status:' + a.status + '\n');
        }
    })
}
function book_remove() {
    let id = $("#book_id").val();
    let number = $("#number").val();
    $.ajax({
        type: 'POST',
        url: urls.book_remove,
        ...
        crossDomain: true,
        complete: function (a) {
            $("#result").val($("#result").val() + JSON.stringify({'id': id, 'number': number})
                + '\n' + 'status:' + a.status + '\n');
        }
    })
}
function book_modify() {
    let id = $("#book_id").val();
    let summary = $("#number").val();
    let max_time = $("#max_time").val();
    let author = $("#author").val();
    let params = {'id': id, 'summary': summary, 'max_time': max_time, 'author': author};
    $.ajax({
        type: 'POST',
        url: urls.book_modify,
        data: JSON.stringify(params),
        dataType: 'json',
        contentType: 'application/json',
        xhrFields: {withCredentials: true},
